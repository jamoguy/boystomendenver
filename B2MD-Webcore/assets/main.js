...
(function() {
								...
								// Determine next position.
									switch (_this.order) {
										...
										case 'random':
											...
											// Randomly pick next position.
												for (;;) {
		
													_this.pos = (Math.ceil(Math.random() * _this.$slides.length) - 1);
		
													// Didn't pick last position? Stop.
	...
	// Container: container16.
		new videoBackground('container16', {
			target: '#container16',
			src: 'assets/videos/container16.mp4',
			poster: 'assets/videos/container16.mp4.jpg',
			position: 'center',
			loop: true
		});
	
	// Container: container05.
		new videoBackground('container05', {
			target: '#container05',
			src: 'assets/videos/container05.mp4',
			poster: 'assets/videos/container05.mp4.jpg',
			position: 'center',
			loop: true
		});
	...
	// Slideshow: slideshow02.
		(function() {
			...
			new slideshowBackground('#slideshow02', {
				...
				images: [
					{
						src: 'assets/images/slideshow02-b4e306d2.jpg',
						position: 'top',
						motion: 'right',
						speed: 2,
						caption: 'Untitled',
					...
					{
						src: 'assets/images/slideshow02-82164cac.jpg',
						position: 'top',
						motion: 'right',
						speed: 3,
						caption: 'Untitled',
	...
	// Slideshow: slideshow03.
		(function() {
			...
			new slideshowBackground('#slideshow03', {
				...
				images: [
					{
						src: 'assets/images/slideshow03-ce70c658.jpg',
						position: 'top right',
						motion: 'left',
						speed: 3,
						caption: 'Untitled',
					...
					{
						src: 'assets/images/slideshow03-d79bc1b0.jpg',
						position: 'top',
						motion: 'left',
						speed: 2,
						caption: 'Untitled',
	...
	// Slideshow: slideshow01.
		(function() {
			...
			new slideshowBackground('#slideshow01', {
				...
				images: [
					{
						src: 'assets/images/slideshow01-0ba7ecfd.jpg',
						position: 'top',
						motion: 'right',
						speed: 3,
						caption: 'Untitled',
					...
					{
						src: 'assets/images/slideshow01-0c2eeee1.jpg',
						position: 'top',
						motion: 'right',
						speed: 2,
						caption: 'Untitled',
	...
	// Initialize "On Visible" animations.
		onvisible.add('.container.style2', { style: 'fade-down', speed: 250, intensity: 5, delay: 0, state: true, replay: false });
